...
Die zweite Projektfrage untersucht, welchen Beitrag Odometrie-Kalibrierung, IMU-Integration, Kanten-Erkennung und LiDAR-basierte Kartierung zur belastbaren Zustands- und Umgebungsbasis leisten. Die Validierung zeigt drei zentrale Ergebnisse. Erstens reduzierte die UMBmark-Kalibrierung den systematischen Odometriefehler um den Faktor $10$ bis $20$. Zweitens sank der laterale Drift auf einer Referenzfahrt über $1{,}0\,\mathrm{m}$ mit IMU-Korrektur von $3{,}5\,\mathrm{cm}$ auf $1{,}5\,\mathrm{cm}$, während der Gierfehler von $2{,}12^\circ$ auf $0{,}69^\circ$ sank. Drittens erreichte die Kartierung einen mittleren Absolute Trajectory Error von $0{,}16\,\mathrm{m}$ und blieb damit unter dem Akzeptanzkriterium von $0{,}20\,\mathrm{m}$. Zusätzlich reagierte die Sicherheitskette bei einem Kantenereignis in unter $45\,\mathrm{ms}$.

PF2 ist damit weitgehend positiv beantwortet. Odometrie-Kalibrierung, IMU-Stützung, LiDAR-basierte Kartierung und priorisierte Sicherheitslogik bilden gemeinsam eine belastbare Grundlage für den Innenraumbetrieb. Die Einschränkung liegt in der noch unvollständigen Einzelbewertung einzelner Sensorpfade wie Ultraschall, Batterieüberwachung und IMU-Plausibilisierung über alle Betriebszustände.
...
### Vollständigkeit des Nachweises

Die Validierung bestätigt den fahrkritischen Kern, aber nicht alle Anforderungen mit gleicher Tiefe. Für den Fahrkern fehlt noch eine vollständige Messreihe zu reproduzierbaren $360^\circ$-Rotationen und zum Nachlauf nach dem Stopp. In der Sensor- und Sicherheitsbasis ist die Kanten-Erkennung belastbar nachgewiesen, während Ultraschall, Batterieüberwachung und IMU-Plausibilisierung noch nicht mit derselben systematischen Tiefe ausgewertet sind. Für die Bedien- und Leitstandsebene fehlt eine eigenständige Untersuchung der Bedienqualität. Die Sprachschnittstelle ist in der Roadmap als Erweiterung beschrieben, gehört aber nicht zum validierten Kernumfang dieser Arbeit.

### Technische Grenzen des Prototyps

Die Kalibrierung reduziert systematische Odometriefehler deutlich, kompensiert aber keinen Schlupf auf wechselnden oder unebenen Untergründen. Das Recovery-Verhalten erhöht die Robustheit der Navigation, beseitigt jedoch nicht alle Blockadesituationen. Die Vision-Pipeline erreicht mit dem Hailo-8L eine mittlere Inferenzzeit von rund $34\,\mathrm{ms}$ pro Bild und ist damit technisch leistungsfähig, bleibt jedoch außerhalb des sicherheitskritischen Kerns. Das Docking erreichte eine Erfolgsquote von $80\,\%$ und zeigte damit technische Machbarkeit, aber noch keine hinreichende Robustheit für eine Kernfunktion. Beleuchtungsartefakte und ungünstige Ankunftsposen wirken sich weiterhin deutlich auf die monokulare Bildauswertung aus.
...
### Übertragbarkeit und wirtschaftliche Einordnung
...
### Kernpfad der Roadmap vervollständigen

Der nächste Entwicklungsschritt sollte nicht mit zusätzlichen Demonstrationsfunktionen beginnen, sondern mit der vollständigen Schließung des Kernpfads. Dazu gehören eine vollständige Messreihe für den Fahrkern, eine systematische Einzelbewertung von Ultraschall, Batterieüberwachung und IMU-Plausibilisierung sowie eine formale Prüfung aller relevanten Zustandsübergänge der Freigabelogik. Für die Navigation ist insbesondere das Recovery-Verhalten weiter zu verbessern, bis Fehlfahrten, Sackgassen und lokale Blockaden reproduzierbar beherrscht werden. Diese Reihenfolge entspricht der Roadmap-Logik, in der quantitative Stabilität vor zusätzlicher Systemkomplexität steht.
