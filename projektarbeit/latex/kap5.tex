...
Der \texttt{cliff\_safety\_node} bildet den sicherheitsnahen Multiplexer für Kantenerkennung. Er abonniert \texttt{/cliff} und überwacht gleichzeitig die eingehenden Fahrkommandos. Erkennt der Sensor-Knoten eine Kante, unterbricht der Multiplexer den regulären Kommandopfad und sendet stattdessen einen Stopp auf das finale Topic \texttt{/cmd\_vel}.
