...
KRITERIEN: list[dict[str, Any]] = [
    ...
    {
        "bereich": "SLAM",
        "kriterium": "TF-Rate map->odom",
        "anforderung": ">= 1.5 Hz",
        "datei": "slam",
        "pfad": "tf_rate_map_odom_hz",
        "pruef": lambda v: v >= 1.5 if v is not None else None,
    },
    {
        "bereich": "SLAM",
        "kriterium": "TF-Rate odom->base_link",
        "anforderung": ">= 15 Hz",
        "datei": "slam",
        "pfad": "tf_rate_odom_base_hz",
        "pruef": lambda v: v >= 15.0 if v is not None else None,
    },
    {
        "bereich": "SLAM",
        "kriterium": "Topic-Rate /odom",
        "anforderung": ">= 15 Hz",
        "datei": "slam",
        "pfad": "topic_rate_odom_hz",
        "pruef": lambda v: v >= 15.0 if v is not None else None,
    },
    {
        "bereich": "SLAM",
        "kriterium": "Topic-Rate /scan",
        "anforderung": ">= 5 Hz",
        "datei": "slam",
        "pfad": "topic_rate_scan_hz",
        "pruef": lambda v: v >= 5.0 if v is not None else None,
    },
    {
        "bereich": "SLAM",
        "kriterium": "Topic-Rate /imu",
        "anforderung": ">= 25 Hz",
        "datei": "slam",
        "pfad": "topic_rate_imu_hz",
        "pruef": lambda v: v >= 25.0 if v is not None else None,
    },
    # --- Navigation ---
    {
        "bereich": "Navigation",
