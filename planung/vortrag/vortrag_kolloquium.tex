...
\begin{frame}{Hybride Vision-Pipeline}
  ...
  \begin{itemize}
    ...
    \item \textbf{Cloud-Semantik:} \texttt{gemini\_semantic\_node} (Modell: \texttt{gemini-2.0-flash-lite}) sendet Detektionen und Telemetrie an Gemini API fuer kontextbasierte Situationsbewertung.
