...
\begin{frame}{Hardwarenahe Sicherheitslogik}
  ...
  \begin{itemize}
    \item \textbf{ROS-2-Pfad (Multiplexer):} Der \texttt{cliff\_safety\_node} blockiert Navigationsbefehle bei erkannter Kante. End-to-End-Latenz (Sensor $\rightarrow$ Stopp): $2{,}0\,\mathrm{ms}$.
    ...
    \item \textbf{Reaktionszeit:} Der CAN-Pfad greift unabhaengig vom Host-System in $< 20\,\mathrm{ms}$.
  \end{itemize}
\end{frame}
...
\begin{frame}{Eigenschaftsabsicherung (PF1 und PF2)}
  ...
  \begin{tabular}{@{}lll@{}}
    ...
    Kanten-Stopp-Latenz  & $2{,}0\,\mathrm{ms}$ (ROS 2 Pfad) & $< 50\,\mathrm{ms}$ \\
...
\begin{frame}{Fazit und Projektbeantwortung}
  ...
  \vspace{1em}
  \textbf{Fazit:}\\
  Ein kostenguenstiges Gesamtsystem (${\sim}\,513\,\mathrm{EUR}$) erfuellt intralogistische Grundlagenanforderungen gemaess VDI 2206. Die Grenzen liegen in den MTU-Beschraenkungen ($512$ Bytes) und Rad-Schlupf.
\end{frame}
