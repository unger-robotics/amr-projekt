...
\begin{frame}{Zielsetzung und Forschungsfragen}
...
\begin{frame}{Zusammenfassung und Ausblick}
  ...
  \begin{itemize}
    ...
    \item Verteilte Drei-Ebenen-Architektur mit zwei ESP32-S3 und einem
          Raspberry Pi~5
    \item Positive Beantwortung aller drei Forschungsfragen mit
          abgestuftem Ergebnis für FF3
